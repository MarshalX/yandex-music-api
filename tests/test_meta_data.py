...
class TestMetaData:
    ...
    def test_de_json_all(self, client):
        json_dict = {'album': self.album, 'volume': self.volume, 'year': self.year, 'number': self.number,
                     'genre': self.genre, 'lyricist': self.lyricist, 'version': self.version, 'composer': self.composer}
