...
Примеры доступны в папке [tests](https://github.com/MarshalX/yandex-music-api/tree/main/tests).
...
Начиная с версии 3.0.0 асинхронная версия клиента является первичной. Синхронная версия генерируется из асинхронной с помощью [`unasync`](https://github.com/python-trio/unasync).
...
Для упрощения жизни в корне проекта существует [Makefile](https://github.com/MarshalX/yandex-music-api/blob/main/Makefile). 
