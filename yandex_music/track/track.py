...
class Track(YandexMusicObject):
    ...
    def like(self, *args, **kwargs):
        ...
        """
        return self.client.users_likes_tracks_add(self.id, self.client.account.uid, *args, **kwargs)
    ...
    def dislike(self, *args, **kwargs):
        ...
        """
        return self.client.users_likes_tracks_remove(self.id, self.client.account.uid, *args, **kwargs)
