##############################################################################################
# THIS IS AUTO GENERATED COPY OF yandex_music/_client_async/clips.py. DON'T EDIT IT BY HANDS #
##############################################################################################
...
class ClipsMixin(ClientBase):
    ...
    @log
    def clips(self, clip_ids: Union[List[Union[str, int]], str, int], *args: Any, **kwargs: Any) -> List[Clip]:
