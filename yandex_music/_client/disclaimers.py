####################################################################################################
# THIS IS AUTO GENERATED COPY OF yandex_music/_client_async/disclaimers.py. DON'T EDIT IT BY HANDS #
####################################################################################################
...
class DisclaimersMixin(ClientBase):
    ...
    def tracks_disclaimer(self, track_id: Union[str, int], *args: Any, **kwargs: Any) -> Optional[Disclaimer]:
        ...
        Raises:
            :class:`yandex_music.exceptions.YandexMusicError`: Базовое исключение библиотеки.
        """
        return self._get_disclaimer('tracks', track_id, *args, **kwargs)

    @log
    def clips_disclaimer(self, clip_id: Union[str, int], *args: Any, **kwargs: Any) -> Optional[Disclaimer]:
        ...
        Raises:
            :class:`yandex_music.exceptions.YandexMusicError`: Базовое исключение библиотеки.
        """
        return self._get_disclaimer('clips', clip_id, *args, **kwargs)
