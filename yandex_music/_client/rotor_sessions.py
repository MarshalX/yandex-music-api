#######################################################################################################
# THIS IS AUTO GENERATED COPY OF yandex_music/_client_async/rotor_sessions.py. DON'T EDIT IT BY HANDS #
#######################################################################################################
...
class RotorSessionsMixin(ClientBase):
    ...
    def rotor_session_new(
        ...
        **kwargs: Any,
        ...
        result = self._request.post(url, json=body, **kwargs)

        return RotorSession.de_json(result, self)

    @log
    def rotor_session_clone(
        self,
    ...
    def rotor_session_feedback(
        ...
        **kwargs: Any,
        ...
        result = self._request.post(url, json=feedback.to_dict(for_request=True), **kwargs)

        return is_dict(result)

    @log
    def rotor_session_feedback_radio_started(
        self,
        radio_session_id: str,
        batch_id: Optional[str] = None,
        from_: Optional[str] = None,
        ...
        **kwargs: Any,
        ...
        return self.rotor_session_feedback(radio_session_id, event, batch_id, from_, **kwargs)

    @log
    def rotor_session_feedback_track_started(
        self,
        radio_session_id: str,
        ...
        **kwargs: Any,
        ...
        return self.rotor_session_feedback(radio_session_id, event, batch_id, **kwargs)

    @log
    def rotor_session_feedback_track_finished(
        self,
        radio_session_id: str,
        track_id: Union[str, int],
    ...
    @log
    def rotor_session_feedback_skip(
        self,
        radio_session_id: str,
        track_id: Union[str, int],
        total_played_seconds: Union[int, float],
    ...
    @log
    def rotor_session_feedbacks(self, radio_session_id: str, feedbacks: List[SessionFeedback], **kwargs: Any) -> bool:
    ...
    @log
    def rotor_sessions_feedbacks(self, sessions: List[SessionFeedbacks], **kwargs: Any) -> bool:
    ...
    @log
    def rotor_combined_session_new(
        self,
    ...
    @log
    def rotor_combined_session_next(
    ...
    @log
    def rotor_combined_session_landing(
        self,
        supported_types: Optional[List[str]] = None,
        child: Optional[bool] = None,
        allow_explicit: Optional[bool] = None,
