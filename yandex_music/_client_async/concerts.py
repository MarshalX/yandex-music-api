...
class ConcertsMixin(ClientBase):
    ...
    @log
    async def concert_info(self, concert_id: str, *args: Any, **kwargs: Any) -> Optional[ConcertInfo]:
    ...
    @log
    async def concerts_locations(self, *args: Any, **kwargs: Any) -> Optional[ConcertLocations]:
    ...
    @log
    async def concerts_tab_config(self, *args: Any, **kwargs: Any) -> Optional[ConcertTabConfig]:
