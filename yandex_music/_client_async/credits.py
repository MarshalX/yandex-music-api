...
class CreditsMixin(ClientBase):
    ...
    @log
    async def tracks_credits(self, track_id: Union[str, int], *args: Any, **kwargs: Any) -> Optional[Credits]:
        ...
        Raises:
            :class:`yandex_music.exceptions.YandexMusicError`: Базовое исключение библиотеки.
        """
        return await self._get_credits('tracks', track_id, *args, **kwargs)

    @log
    async def clips_credits(self, clip_id: Union[str, int], *args: Any, **kwargs: Any) -> Optional[Credits]:
        ...
        Raises:
            :class:`yandex_music.exceptions.YandexMusicError`: Базовое исключение библиотеки.
        """
        return await self._get_credits('clips', clip_id, *args, **kwargs)
