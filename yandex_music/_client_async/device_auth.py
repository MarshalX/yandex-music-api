...
class DeviceAuthMixin(ClientBase):
    ...
    async def request_device_code(
        ...
        result = await self._request.post(f'{_OAUTH_BASE_URL}/device/code', data)
    ...
    async def poll_device_token(
        ...
        try:
            result = await self._request.post(f'{_OAUTH_BASE_URL}/token', data)
    ...
    async def device_auth(
        ...
        """
        code = await self.request_device_code(device_id, device_name, client_id)
        ...
        while True:
            ...
            token = await self.poll_device_token(code.device_code, client_id, client_secret)
